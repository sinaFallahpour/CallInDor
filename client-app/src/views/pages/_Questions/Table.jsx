...
class Table extends React.Component {
  ...
  async populatingCurrentData(ida) {
    ...
    try {
      ...
      const { data } = await agent.Questions.details(ida);
      let {
        id,
        text,
        englishText,
  ...
  async componentDidMount() {
    const { data } = await agent.Questions.list();
  ...
  addToQuestions = async (newQuestion) => {
    const rowData = [...this.state.rowData, newQuestion];
    this.setState({ rowData });
  };

  editToQuestions = async (newQuestion) => {
    let rowData = [...this.state.rowData];
    let index = rowData.findIndex((el) => el.id == newQuestion.id /* condition */);
    rowData[index] = newQuestion;
    this.setState({ rowData });
