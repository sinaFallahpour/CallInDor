            ...
            <Card>
                ...
                >
                    <div className="icon-section">
                        <div
                            className={`avatar avatar-stats p-50 m-0 ${this.props.iconBg
                                ? `bg-rgba-${this.props.iconBg}`
                                : "bg-rgba-primary"
                                }`}
                        >
                            <div className="avatar-content" onClick={() => { this.props.toggleModal(this.props.role); }}>{this.props.icon}</div>
                        </div>
                    </div>
                    <div className="title-section">
                        ...
                        <p>
                            ...
                            {this.props.isEnabled ?
                                ...
                                :
                                <div className="badge badge-pill badge-light-warning">DeActivated</div>
                            }
                        </p>
                    </div>
                </CardBody>
