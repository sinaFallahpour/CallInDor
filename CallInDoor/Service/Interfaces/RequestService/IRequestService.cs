...
namespace Service.Interfaces.RequestService
{
    public interface IRequestService
    {
        ...
        (bool succsseded, List<string> result) ValidateRequestToPeriodedOrSessionChatService(BaseMyServiceTBL baseServiceFromDB, AppUser provider, AppUser currentUser, bool hasReserveRequest);
