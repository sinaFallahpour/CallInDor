...
namespace Domain.Migrations
{
    ...
    [Migration("20210116092551_smCngs")]
    partial class smCngs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.TransactionTBL", b =>
                {
                    ...
                    b.Property<int?>("UserTopTenPackageId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserTopTenPackageId")
                        .IsUnique()
                        .HasFilter("[UserTopTenPackageId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.User_TopTenPackageTBL", b =>
                {
                    ...
                    b.Property<int?>("TransactionTBLId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.TopTenPackageTBL", b =>
                {
                    b.HasOne("Domain.Entities.ServiceTBL", "ServiceTbl")
                        .WithOne("TopTenPackageTBL")
                        .HasForeignKey("Domain.Entities.TopTenPackageTBL", "ServiceId");
                });
            ...
            modelBuilder.Entity("Domain.Entities.TransactionTBL", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User_TopTenPackageTBL", "User_TopTenPackageTBL")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.TransactionTBL", "UserTopTenPackageId");
                });
            ...
            modelBuilder.Entity("Domain.Entities.User_TopTenPackageTBL", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.TransactionTBL", "TransactionTBL")
                        .WithMany()
                        .HasForeignKey("TransactionTBLId");
                });
