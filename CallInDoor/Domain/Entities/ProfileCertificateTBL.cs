...
namespace Domain.Entities
{
    ...
    public class ProfileCertificateTBL : BaseEntity<int>
    {
        ...
        [ForeignKey("RequiredCertificatesId")]
        public ServidceTypeRequiredCertificatesTBL ServidceTypeRequiredCertificatesTBL { get; set; }

        public int? RequiredCertificatesId { get; set; }
