...
namespace Domain.Enums
{
    public enum TransactionStatus
    {
        ...
        /// <summary>
        //مبلغ که برای خرید پکیج هایی که برای چت های آنلیمیتد هست  
        /// </summary>
        [Description("مبلغ که برای خرید پکیج هایی که برای چت های آنلیمیتد هست")]
        [Display(Name = "مبلغ که برای خرید پکیج هایی که برای چت های آنلیمیتد هست")]
        BuyChatLimitePackage,
